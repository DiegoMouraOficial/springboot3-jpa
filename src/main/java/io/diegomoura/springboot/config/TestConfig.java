...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order order1 = new Order(null, Instant.parse("2024-01-20T19:53:07Z"), user1 );
        Order order2 = new Order(null, Instant.parse("2024-02-22T04:23:15Z"), user2 );
        Order order3 = new Order(null, Instant.parse("2024-05-30T15:20:27Z"), user3 );
